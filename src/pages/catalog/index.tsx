    ...
    <HomeLayout>
      <div className="flex gap-4 mx-auto pb-5">
        ...
        <div className="w-full ">
          <h4 className="pb-6 px-2">
            Choose a category to browse Conway product for that machine
          </h4>
          <div className="h-screen overflow-auto overflow-y-scroll grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5">
            {/* Card */}
