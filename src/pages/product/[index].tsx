...
export default function ProductPage() {
  return (
    <HomeLayout>
      <div className="flex text-black font-poppins mt-4">
        <div className="w-7/12">
          ...
          <p className="mb-8 w-4/5">
            ...
            900 ER. The axles come installed in the end fittings. Contact us for
            a quote. There is another version available for running corrugated
            board. Ask your salesperson about 10-351-1-00-00
          </p>
